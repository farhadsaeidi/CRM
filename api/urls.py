...
ledger_patterns = [
    ...
    path("reminders/debtors/", home_views.DebtorReminderListView.as_view(), name="reminder_debtors"),
    path("reminders/send/", home_views.DebtorReminderSendView.as_view(), name="reminder_send"),
...
chat_patterns = [
    ...
    path("chat/pins/", chat_views.PinListCreateView.as_view(), name="chat_pins"),
    path("chat/pins/<int:pk>/", chat_views.PinDetailView.as_view(), name="chat_pin_detail"),
