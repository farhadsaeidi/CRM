...
const MODES = {
    create: {
        ...
        submit: "ثبت تراکنش",
        icon: FiPlus,
        topBorder: "border-t-var-color-31!",
        badge: "text-var-color-01 dark:text-var-color-31 bg-var-color-31 dark:bg-var-color-29 border border-var-color-31 dark:border-var-color-30 rounded-full",
        badgeIcon: "w-8 h-8",
        button: "btn-greenish",
        submitIcon: "w-7 h-7 ml-0.5",
        input: "input-greenish",
        fieldIcon: "text-var-color-31",
    },
    edit: {
        title: "ویرایش تراکنش",
