...
const Register = ({active = false}) => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            // سرور بعد از ثبت‌نام خودش کاربر را وارد می‌کند، پس نیازی به ورود دوباره نیست
    ...
    return (
        <form className="w-100 h-127 rounded-3xl px-6 pt-6 pb-8 form-container" onSubmit={onSubmit} autoComplete="off" inert={!active}>
            ...
            <main className="w-full mt-5">
                ...
                <div className="w-full">
                    ...
                    <div className="relative w-full h-10 mt-2">
                        <FiUser className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-var-color-15 pointer-events-none"/>
                        <input
                            id={id + "fullname"}
                            ref={setInputRef(0)}
                            type="text"
                            ...
                            className={`w-full h-full text-[15px] pr-8.5 pl-3 rounded-xl input input-bluish input-placeholder ${errors.fullname ? "input-error" : ""}`}
                        />
                    </div>
                </div>
                ...
                <div className="w-full mt-5">
                    ...
                    <div className="relative w-full h-10 mt-2">
                        ...
                        <input
                            ...
                            className={`w-full h-full text-[15px] pr-8.5 pl-3 rounded-xl input input-bluish input-placeholder ${errors.phone ? "input-error" : ""}`}
                        />
                    </div>
                </div>
            ...
            <footer className="flex justify-center items-center mt-6">
                <p className="m-0 text-var-color-06 dark:text-var-color-03 text-base cursor-default">حساب کاربری دارم.</p>
