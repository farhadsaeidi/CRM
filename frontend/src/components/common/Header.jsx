...
// دکمهٔ اقدامِ هدر با رویدادِ سراسری کار می‌کند نه پراپ، چون هدر داخل RootLayout
// رندر می‌شود و صفحه‌ها فرزندِ Outlet هستند؛ رد کردنِ callback از این مسیر یعنی
// RootLayout باید state هر صفحه را بشناسد. صفحه‌ای که مودال دارد به رویداد گوش می‌دهد.
export const NEW_CUSTOMER_EVENT = "crm:new-customer";
        ...
        <header className="w-full h-(--header-height) shrink-0 py-3.5 px-4.5 flex justify-between items-center gap-3 rounded-[18px] bg-var-color-00 dark:bg-var-color-36 border border-var-color-02 dark:border-var-color-38">
            ...
            <div className="shrink-0 flex items-center gap-4">
                ...
                <button
                    ...
                    onClick={() => window.dispatchEvent(new CustomEvent(NEW_CUSTOMER_EVENT))}
                >
